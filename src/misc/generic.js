...
const _instance = {
    ...
    parseValue(value, dataType) {
        ...
        switch (dataType) {
            ...
            case this.Number:
                ...
                break
            case this.Hex:
                res = _.isString(value) ? parseInt(value, 16) : this.DefaultValue.Hex
                break
            case this.Boolean:
    ...
    selectValue(object, key, dataType) {
        ...
        return this.parseValue(tmpObj, dataType) // this.dataValid(tmpObj, dataType) ? tmpObj : this.DefaultValue[dataType]
    },
